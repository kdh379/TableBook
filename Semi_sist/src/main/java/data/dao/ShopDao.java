...
public class ShopDao {
	...
	public ShopDto getOneShop(String num) {
		...
		return dto;
			...
			//페이지에서 필요한 만큼만 리턴하기(전체출력)_search에 해당하는 음식점만
			public Vector<ShopDto> getSearchList(int start, int perpage, String search){
				...
				String sql="select * from shop where name like ? or tag like ? or addr like ? order by num desc limit ?,?";
