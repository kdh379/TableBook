    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="realindex.jsp/shop/questionform.jsp">입점문의</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <section id="services">
            <div class="container">
				...
				<button type="submit" style="outline: none; float: right; position: absolute; margin-left: 10px; background-color: rgb(254,225,14); width: 80px; height: 80px; border: none; border-radius: 80px; color: rgb(108,117,126);" onclick="location.href='list/searchresult.jsp';">
