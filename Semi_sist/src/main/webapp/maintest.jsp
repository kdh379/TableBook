...
<html lang="ko">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#portfolio">평점순</a></li>
                        <li class="nav-item"><a class="nav-link" href="#about">리뷰순</a></li>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">검색</h2>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">입점 문의</h2>
                    <h3 class="section-subheading text-muted">Taste Book에 입점하세요</h3>
                </div>
                <!-- * * * * * * * * * * * * * * *-->
